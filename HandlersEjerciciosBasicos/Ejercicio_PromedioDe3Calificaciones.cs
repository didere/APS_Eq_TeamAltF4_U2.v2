    ...
    public class Ejercicio_PromedioDe3Calificaciones<T> : Ejercicio where T : INumber<T>
    {
        ...
        public Calificaciones<T> Cal1
        {
            ...
            set
            {
                if (value == null)
                {
                    throw new ArgumentNullException("Cal1 no puede ser nulo.");
                }
                cal1 = value;
            }
        }

        public Calificaciones<T> Cal2
        {
            get => cal2;
            set
            {
                if (value == null)
                {
                    throw new ArgumentNullException("Cal2 no puede ser nulo.");
                }
                cal2 = value;
            }
        }

        public Calificaciones<T> Cal3
        {
            get => cal3;
            set
            {
                if (value == null)
                {
                    throw new ArgumentNullException("Cal3 no puede ser nulo.");
                }
                cal3 = value;
            }
        }
